...
const wallet = ethers.Wallet.fromMnemonic(mnemonic, `m/44'/60'/0'/0/4`);
          ...
          if (!Data){//✅ Checked Data.name === 'addLiquidity' || 
            ...
            console.time("+10 Gwei")  
              ...
              const tx = await R_router.swapExactTokensForTokens(
                  ...
                  {
                    gasPrice: transaction.gasPrice+ ethers.utils.parseUnits('10', 'wei'),
                    gasLimit: transaction.gasLimit
                  }
              );
              console.timeEnd("+10 Gwei")
